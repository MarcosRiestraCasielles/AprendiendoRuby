...
#EL load lee todo el fichero cada vez que se le pase esta instrucción,
#el require no.
...
#SI lo pones entre comillas dobles, ruby interpreta lo que hay dentro, en cambio, si lo
#pones entre comillas simples no lo interpreta, por tanto es menor el tiempo de ejecucion


#puts "La ruta de adquisión de ficheros es #{$global_route}, "
...
#aunque tengamos esto, la clase heredada nos va a sobreescribir los meétodos
# NO va a trabajar conjuntamente con ellos, para ello hay que definir un metodo
# que va a ser el que se modifique en la clase derivada, se va a hacer referencia a este
# método dentro de la clase padre, de forma que la parte común se indique en
